...
export const layoutConfig = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "微信咨询按钮文字",
      type: "string",
      description: "[前台位置: 全站顶部导航栏微信咨询按钮文字]",
      initialValue: "微信咨询",
    }),
    defineField({
      ...
      title: "微信弹窗标题",
      type: "string",
      description: "[前台位置: 全站顶部导航栏微信二维码弹窗标题]",
      initialValue: "添加微信",
    }),
    defineField({
      ...
      title: "微信弹窗描述",
      type: "string",
      description: "[前台位置: 全站顶部导航栏微信二维码弹窗描述文字]",
    ...
    defineField({
      ...
      title: "二维码占位文字",
      type: "string",
      description: "[前台位置: 全站顶部导航栏未上传二维码时的占位文字]",
      initialValue: "公众号二维码",
    }),
    ...
    defineField({
      ...
      title: "浮动电话按钮文字",
      type: "string",
      description: "[前台位置: 手机端底部浮动栏电话按钮文字]",
      initialValue: "电话沟通",
    }),
    defineField({
      ...
      title: "浮动咨询按钮文字",
      type: "string",
      description: "[前台位置: 手机端底部浮动栏咨询按钮文字]",
      initialValue: "免费咨询方案",
    }),
  ],
  preview: {
